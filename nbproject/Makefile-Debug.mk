...
LDLIBSOPTIONS=-lcurses -lmenu -lpthread
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/epsolar_commander: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/epsolar_commander ${OBJECTFILES} ${LDLIBSOPTIONS} -lepsolar -llog4c -lmodbus
...
${OBJECTDIR}/loadPanel.o: loadPanel.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/loadPanel.o loadPanel.c
...
${OBJECTDIR}/readSCCvalues.o: readSCCvalues.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/readSCCvalues.o readSCCvalues.c
